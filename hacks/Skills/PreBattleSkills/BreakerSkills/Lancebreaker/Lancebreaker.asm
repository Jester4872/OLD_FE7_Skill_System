...
CheckCharacterAtk:
    ...
    ldr     r3,LancebreakerID     @load the ID value we have defined
...
CheckEnemyWeaponAtk:
    ...
    cmp     r2,#0x01              @is the enemy weapon type a lance?
...
.ltorg
.align
LancebreakerID:                    @refer to the value defined in the event file
