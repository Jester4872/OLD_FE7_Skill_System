...
CheckCharacter:
    ...
    ldr     r3,DrowsyID         @load the ID value we have defined
...
CheckAllegiance:
    ...
    bge		Drowsy              @if enemy unit, navigate to the skill
...
Drowsy:
    ...
    mov     r1,#0x2             @get the byte for berserk
...
.ltorg
.align
DrowsyID:                       @refer to the value defined in the event file
