...
push    {r0-r7}                 @stpre the values of these registers on the stack so we can use them
...
CheckCharacter:
    ...
    ldr     r3,BlackMagicID     @load the ID value we have defined
...
CheckAllegiance:
    ...
    bge		BlackMagic          @if enemy unit, navigate to the skill
...
.ltorg
.align
BlackMagicID:                   @refer to the value defined in the event file
