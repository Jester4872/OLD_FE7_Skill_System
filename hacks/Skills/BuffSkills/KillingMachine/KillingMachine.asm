...
CheckCharacterID:
    ...
    ldr     r3,KillingMachineID @load the character ID value we have defined in the event file
...
ApplyFlag:
    ...
    b       KillingMachine      @and now we branch to apply the sill

KillingMachine:                 
    lsl     r0,#1               @take the crit rate in r0 and perform a logical shift left by 1 place (doubling the value)
...
.ltorg
.align
KillingMachineID:               @refer to the value defined in the event file
