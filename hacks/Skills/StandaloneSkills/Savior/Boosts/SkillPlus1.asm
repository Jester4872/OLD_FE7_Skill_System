...
CheckCharacter:             
    mov     r0,#0x15            @get the skill bit
    ldsb    r0,[r4,r0]          @load the skill value
    lsr     r2,r0,#0x1F
...
End:
    add     r0,r0,r1            @add the skill and boost together for the final total (we store it back in the vanilla function)
    asr     r0,r0,#0x1
    pop     {r2,r5}
    pop     {r3}
    bx      r3
